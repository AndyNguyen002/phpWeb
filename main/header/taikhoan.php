...
<ul class="navbar-nav mb-1 ml-auto" >
                            ...
                            <?php if(isset($user['username'])){ ?>
                                ...
                                <a class="nav-link text-dark text-uppercase" href="#" style="display:inline-block; margin-bottom:18px;"> <?php echo $user['fullname'] ?> </a>
                     ...
                     <?php }else { ?>
                        <div class="dropdown">
                                ...
                                <a class="nav-link text-dark text-uppercase" href="#" style=""> Tài khoản </a>
